...
namespace Mango {
	...
	void EditorCamera::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(MGO_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
	}
	...
	void EditorCamera::UpdateView()
	{
		...
		m_ViewMatrix = glm::inverse(glm::translate(m_Position) * glm::toMat4(orientation));
	}
