	...
	: Layer("Example"), m_CameraController(1280.0f / 720.0f, true)
{
	...
	Mango::Ref<Mango::VertexBuffer> vertexBuffer = Mango::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Mango::Ref<Mango::IndexBuffer> indexBuffer = Mango::IndexBuffer::Create(indices, 3);
	...
	Mango::Ref<Mango::VertexBuffer> squareVB = Mango::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Mango::ShaderDataType::Float3, "a_Position" },
	...
	Mango::Ref<Mango::IndexBuffer> squareIB = Mango::IndexBuffer::Create(squareIndices, 6);
...
inline void ExampleLayer::OnUpdate(Mango::Timestep ts)
{
	// Update
...
inline void ExampleLayer::OnEvent(Mango::Event& e)
{
